...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference("History.count") do
      post histories_url, params: { history: { Category: @history.Category, Data: @history.Data, Finish: @history.Finish, YearEnd: @history.YearEnd, YearStart: @history.YearStart } }
    end
